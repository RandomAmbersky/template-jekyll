...
# Errors and faults and some one little thing

+ При добавлении новых страничек их просто не видно.
+ Jeckyll упал при создании нового сайта... Думаю из-за того что создается через Jekyll а потом обрабатывается через bundle exec...
+ Работа с git требуется и в других проектах - переделать на мега-проект с подключаемыми плагинами через размещение в папках (?)
